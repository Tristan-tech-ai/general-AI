...
| L3 | LR per model dan encoder dibekukan | 5 | 77.52 (5.83) | **-12.98** | 0.005 | 0.022 | 0.8583 | 22.43 |
| L4 | Early stopping pada EER | 5 | 86.75 (4.41) | **+9.23** | 0.024 | 0.072 | 0.9368 | 13.27 |
| L5 | Augmentasi penuh | 3 | 89.15 (3.49) | **+2.41** | 0.430 | 0.430 | 0.9540 | 10.81 |
...
**L3, LR per model dan encoder dibekukan.** Perubahan yang dilakukan adalah encoder tidak lagi dilatih, head 0,001 dan encoder 2e-5, ditambah agregasi berbobot antar lapisan. Langkah ini menurunkan akurasi sebesar 12.98 poin persentase menjadi 77.52 persen, dengan AUC 0.8583 dan EER 22.43 persen.

**L4, Early stopping pada EER.** Perubahan yang dilakukan adalah 10 epoch dengan pemilihan bobot terbaik menurut EER validasi. Langkah ini menaikkan akurasi sebesar 9.23 poin persentase menjadi 86.75 persen, dengan AUC 0.9368 dan EER 13.27 persen.

**L5, Augmentasi penuh.** Perubahan yang dilakukan adalah augmentasi noise saja diganti augmentasi penuh, yaitu codec, noise, reverb, dan band-gain. Langkah ini menaikkan akurasi sebesar 2.41 poin persentase menjadi 89.15 persen, dengan AUC 0.9540 dan EER 10.81 persen.

## Bacaan

Empat selisih diuji sekaligus, sehingga koreksi Holm-Bonferroni diterapkan dan keputusan diambil dari kolom p Holm.

Langkah yang selisihnya melampaui ragam antar inisialisasi: L3 (-12.98 poin, p Holm 0.022).

Langkah yang berada di garis batas dan belum dapat dinyatakan mapan: L4 (+9.23 poin, p Holm 0.072).

Langkah yang selisihnya belum terbukti berbeda dari nol: L2 (-3.06 poin, p Holm 0.197); L5 (+2.41 poin, p Holm 0.430).
